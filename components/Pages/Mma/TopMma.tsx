...
export default function TopMma() {
    return (
                            ...
                            <div className="row w-100 pt-md-5">
                                <div className="col-12">
                                    <div className="top_matches__title d-flex align-items-center gap-2 mb-4 mb-md-5">
                                        <Image src="/images/icon/rise.png" width={30}
                                            height={30} alt="Icon" />
                                        <h3>RISE</h3>
                                    </div>
                                                    ...
                                                    <div className="top_matches__clubname">
                                                        <div
                                                            ...
                                                            <div className="d-flex align-items-center gap-1">
                                                                <Image src="/images/icon/mma2.png" width={16} height={16}
                                                                    alt="Icon" /> <span
                                                                        className="fs-eight cpoint">Rise World Series</span>
                                                            </div>
                                                            <div
                                                        ...
                                                        <div
                                                            ...
                                                            <div>
                                                                <div
                                                                    ...
                                                                    <Image className="rounded-5" src="/images/icon/mma.png" width={24} height={24}
                                                                        alt="Icon" /> <span
                                                                            className="fs-seven cpoint">P. Kiatmoo9</span>
                                                                </div>
                                                                <div className="d-flex align-items-center gap-2">
                                                                    <Image className="rounded-5" src="/images/icon/mma.png" width={24} height={24}
                                                                        alt="Icon" /> <span
                                                                            className="fs-seven cpoint">Collins, Chadd</span>
                                                                </div>
                                                            </div>
                                                            <div
