...
export default function UpCmingFutsal() {
  return (
              ...
              <div className="row w-100 mb-8 mb-md-10">
                <div className="col-12">
                  <div className="top_matches__title d-flex align-items-center gap-2 mb-4 mb-md-6">
                    <Image src="/images/icon/russia.png" width={32}
                      height={32} alt="Icon" />
                    <h3>Russia</h3>
                  </div>
                              ...
                              <div>
                                <div className="d-flex align-items-center gap-2 mb-4">
                                  <Image className="rounded-5"
                                    ...
                                    alt="Icon" /> <span className="fs-seven cpoint">Bsf
                                      Bochnia</span>
                                </div>
                                <div className="d-flex align-items-center gap-2">
                                  <Image className="rounded-5"
                                    src="/images/icon/futsal-league.png" width={24} height={24}
                                    alt="Icon" /> <span
                                      className="fs-seven cpoint">Przemysl</span>
                                </div>
                              </div>
                              <div
                        ...
                        <div className="col-xl-5 col-xxl-4">
                          <div className="top_matches__clubname">
                            <div
                              ...
                              <div className="d-flex align-items-center gap-1">
                                <Image src="/images/icon/futsal.png" width={16} height={16} alt="Icon" /> <span
                                  className="fs-eight cpoint">Rugby Pro D2</span>
                              </div>
                              <div
                                className="d-flex align-items-center gap-4 pe-xl-15 flex-nowrap flex-xl-wrap">
                            ...
                            <div
                              ...
                              <div>
                                <div className="d-flex align-items-center gap-2 mb-4">
                                  <Image className="rounded-5"
                                    src="/images/icon/colomiers-rugby.png" width={24} height={24}
                                    alt="Icon" /> <span className="fs-seven cpoint">Colomiers
                                      Rugby</span>
                                </div>
                                <div className="d-flex align-items-center gap-2">
                                  <Image className="rounded-5"
                                    src="/images/icon/ac-brive.png" width={24} height={24} alt="Icon" />
                                  <span className="fs-seven cpoint">AC Brive</span>
                                </div>
                              </div>
                              <div
                                className="d-flex align-items-center gap-4 position-relative pe-xl-15">
                              ...
                              <table className="table mb-0 pb-0">
                                <thead>
                                  <tr className="text-center ">
                                    ...
                                    <th scope="col"><span className="fs-eight">Draw no
                                      bet</span>
                                    </th>
                                  </tr>
                                </thead>
                          ...
                          <div className="top_matches__clubname">
                            ...
                            <div
                              ...
                              <div>
                                <div className="d-flex align-items-center gap-2 mb-4">
                                  <Image className="rounded-5"
                                    src="/images/icon/uson-nevers.png" width={24} height={24} alt="Icon" />
                                  <span className="fs-seven cpoint">Uson Nevers</span>
                                </div>
                                <div className="d-flex align-items-center gap-2">
                                  <Image className="rounded-5"
                                    src="/images/icon/stade-aur.png" width={24} height={24} alt="Icon" />
                                  <span className="fs-seven cpoint">Stade Montois Rugby</span>
                                </div>
                              </div>
                              <div
                                className="d-flex align-items-center gap-4 position-relative pe-xl-15">
