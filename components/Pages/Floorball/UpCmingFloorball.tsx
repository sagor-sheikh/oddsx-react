...
export default function UpCmingFloorball() {
    return (
                            ...
                            <div className="row w-100 mb-8 mb-md-10">
                                <div className="col-12">
                                    <div className="top_matches__title d-flex align-items-center gap-2 mb-4 mb-md-6">
                                        <Image src="/images/icon/czech-republic.png" width={32}
                                            height={32} alt="Icon" />
                                                            ...
                                                            <div>
                                                                <div
                                                                    ...
                                                                    <Image className="rounded-5" src="/images/icon/futsal-league.png" width={24} height={24}
                                                                        alt="Icon" /> <span
                                                                            className="fs-seven cpoint">Bsf Bochnia</span>
                                                                </div>
                                                    ...
                                                    <div className="top_matches__clubname">
                                                        ...
                                                        <div
                                                            ...
                                                            <div>
                                                                <div
                                                                    className="d-flex align-items-center gap-2 mb-4">
                                                                    <Image className="rounded-5" src="/images/icon/fc-shakhtar.png" width={24} height={24}
                                                                        alt="Icon" /> <span
                                                                            className="fs-seven cpoint">AZS Uw Wilanow</span>
                                                                </div>
                                                                <div className="d-flex align-items-center gap-2">
                                                                    <Image className="rounded-5" src="/images/icon/futsal-league.png" width={24} height={24}
                                                                        alt="Icon" /> <span
                                                                            className="fs-seven cpoint">Widzew Lodz</span>
                                                                </div>
                                                            </div>
                                                            <div
                                                                className="d-flex align-items-center gap-4 position-relative pe-xl-15">
