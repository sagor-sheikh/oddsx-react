...
export default function FloorballLive() {
    return (
                            ...
                            <div className="row w-100 mb-4 mb-md-6">
                                <div className="col-12">
                                    <div className="top_matches__title d-flex align-items-center gap-2 mb-4 mb-md-6">
                                        <Image src="/images/icon/rugby-union.png" width={32}
                                            height={32} alt="Icon" />
                                        <h3>International</h3>
                                    </div>
                                                    ...
                                                    <div className="top_matches__clubname">
                                                        ...
                                                        <div
                                                            ...
                                                            <div>
                                                                <div
                                                                    className="d-flex align-items-center gap-2 mb-4">
                                                                    <Image className="rounded-5" src="/images/icon/colomiers-rugby.png" width={24} height={24}
                                                                        alt="Icon" /> <span
                                                                            className="fs-seven cpoint">Colomiers Rugby</span>
                                                                </div>
                                                                <div className="d-flex align-items-center gap-2">
                                                                    <Image className="rounded-5" src="/images/icon/ac-brive.png" width={24} height={24}
                                                                        alt="Icon" /> <span
                                                    ...
                                                    <div className="top_matches__clubname">
                                                        ...
                                                        <div
                                                            ...
                                                            <div>
                                                                <div
                                                                    className="d-flex align-items-center gap-2 mb-4">
                                                                    <Image className="rounded-5" src="/images/icon/uson-nevers.png" width={24} height={24}
                                                                        alt="Icon" /> <span
                                                                            className="fs-seven cpoint">Uson Nevers</span>
                                                                </div>
                                                                <div className="d-flex align-items-center gap-2">
                                                                    <Image className="rounded-5" src="/images/icon/stade-aur.png" width={24} height={24}
                                                                        alt="Icon" /> <span
                                                                            className="fs-seven cpoint">Stade Montois Rugby</span>
                                                                </div>
                                                            </div>
                                                            <div
                                                                className="d-flex align-items-center gap-4 position-relative pe-xl-15">
