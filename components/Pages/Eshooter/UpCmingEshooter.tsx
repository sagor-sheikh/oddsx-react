...
export default function UpCmingEshooter() {
  return (
                          ...
                          <div className="top_matches__clubname">
                            <div
                              ...
                              <div className="d-flex align-items-center gap-1">
                                <Image src="/images/icon/counter-strike.png" width={16} height={16} alt="Icon" /> <span
                                  className="fs-eight cpoint">Copa America</span>
                              </div>
                              <div
                              ...
                              <div>
                                <div className="d-flex align-items-center gap-2 mb-4">
                                  <Image className="rounded-5"
                                    src="/images/icon/ulsan-hyundai.png" width={24} height={24} alt="Icon" />
                                  <span className="fs-seven cpoint">Uruguay</span>
                                </div>
                                <div className="d-flex align-items-center gap-2">
                                  <Image src="/images/icon/baroda.png" width={24} height={24} alt="Icon" />
                                  <span className="fs-seven cpoint">Brazil</span>
                                </div>
                              </div>
                              <div
                              ...
                              <table className="table mb-0 pb-0">
                                <thead>
                                  <tr className="text-center">
                                    ...
                                    <th scope="col"><span className="fs-eight">Total runs</span>
                                    </th>
                                  </tr>
                                </thead>
                                <tbody>
                          ...
                          <div className="top_matches__clubname">
                            ...
                            <div
                              ...
                              <div>
                                <div className="d-flex align-items-center gap-2 mb-4">
                                  <Image className="rounded-5"
                                    src="/images/icon/borussia-bortmund.png" width={24} height={24} alt="Icon" />
                                  <span className="fs-seven cpoint">Brazil</span>
                                </div>
                                <div className="d-flex align-items-center gap-2">
                                  <Image src="/images/icon/santos.png" width={24} height={24} alt="Icon" />
                                  <span className="fs-seven cpoint">Germany</span>
                                </div>
                              </div>
                              <div
                                className="d-flex align-items-center gap-4 position-relative pe-xl-15">
